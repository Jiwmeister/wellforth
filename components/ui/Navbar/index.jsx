...
const Navbar = () => {
    ...
    return (
        <header>
            <nav className={"bg-white md:text-sm fixed w-full top-0 z-10"}>
                    ...
                    <div className={`flex-1 pb-3 mt-8 md:pb-0 md:mt-0 md:block ${state ? "" : "hidden"}`}>
                        <ul className="text-gray-700 justify-end items-center space-y-6 md:flex md:space-x-6 md:space-y-0 md:text-gray-600 md:font-medium">
                            ...
                            <li>
                                <NavLink
                                    href="/get-started"
                                    className="block font-medium text-sm text-white bg-brass hover:bg-gray-600 active:bg-gray-900 md:inline"
                                >
                                    Contact us
                                </NavLink>
                            </li>
