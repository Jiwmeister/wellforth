          ...
          <div className='max-w-lg mx-auto gap-12 justify-between lg:flex lg:max-w-none'>
            <div className='max-w-lg sm:text-center lg:text-left'>
              ...
              <p className='mt-3'>
                ...
                <a
                  href='mailto:hello@glowdiaries.com'
                  target='_blank'
                  rel='noreferrer'
                  className='text-brass hover:text-brass font-medium duration-150'>
                  hello@glowdiaries.com.
                </a>
              </p>
            </div>
            <div className='flex-1 mt-12 sm:max-w-lg lg:max-w-md lg:mt-0'>
              <form
                ...
                <div className='pt-1'>
                  <Button className='w-full text-white bg-brass'>
                    Submit
                  </Button>
                </div>
              </form>
